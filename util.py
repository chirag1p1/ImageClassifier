...
def train_model(model, optimizer, learning_rate,train_loader,valid_loader,criterion,epoch_number, checkpoint_path, gpu ='gpu'):
...
def predict(image_path, model, cat_to_name, topk=5, gpu = 'gpu'):
